  ...
  <div className="mt-24 bg-primary bg-[url('/cta-bg.jpg')] bg-cover bg-[center_bottom] rounded-[3rem] py-36 px-12 text-white text-center relative overflow-hidden">
    ...
    <div className="relative z-10 flex flex-col items-center">
      ...
      <div className="flex flex-wrap justify-center gap-4 mb-12">
        ...
        <a href="https://t.me/Meloset" target="_blank" rel="noopener noreferrer" className="bg-black/40 backdrop-blur-md border border-white/20 text-white px-8 py-4 rounded-full font-bold flex items-center gap-2 hover:bg-black/60 transition-all group">
          Telegram <Send className="w-5 h-5 group-hover:scale-110 transition-transform" />
        </a>
      </div>

      <div className="flex gap-8">
        <a href="https://instagram.com/Meloset" target="_blank" rel="noopener noreferrer" className="flex flex-col items-center gap-2 opacity-70 hover:opacity-100 transition-opacity">
          <Instagram className="w-6 h-6" />
          <span className="text-[10px] font-bold uppercase tracking-widest">Instagram</span>
        </a>
        <a href="mailto:Meloset@gmail.com" className="flex flex-col items-center gap-2 opacity-70 hover:opacity-100 transition-opacity">
